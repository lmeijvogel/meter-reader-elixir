defmodule MessageDecoderTest do
  ...
  test "decode start of message" do
    message_start_marker = "/KFM5KAIFA-METER"

    result = @subject.decode("/KFM5KAIFA-METER", message_start_marker, %{})
  ...
  test "decode empty line" do
    ...
    {:added, state} = @subject.decode("/KFM5KAIFA-METER", message_start_marker, %{})
